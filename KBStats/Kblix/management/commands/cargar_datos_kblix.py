...
DATOS = {
    ...
    'Sprint 4': {
        ...
        'Sorairo':   ['Farlopez', 'Polucion', 'Invictutus', 'Demon', 'Ranita', 'Marakas', 'Wesele', 'MaikyG', 'Duncan','DJMiniMatrix','Dr Filtros'],
    ...
    'Split 3': {
        ...
        'Chiru':      ['Minito', 'Dakin', 'Sporfu', 'Karmac', 'Horizon',  'Thaiger', 'Monchi'],
