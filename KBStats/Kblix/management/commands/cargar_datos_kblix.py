...
DATOS = {
    'Split 2': {
        ...
        'Ronin':       ['jk', 'Bakis', 'JoseOli', 'xRoxas', 'melon pan', 'Lolex', 'Reiko', 'Comunisma'],
        'Kuru':        ['Igrid', 'Sons', 'Hidon', 'Menos20', 'PrarX'],
        'Kemono':      ['TinkyWinky', 'Paellero', 'Ctrl4enjoyer', 'Dwailet', 'Isaacs', 'Seda', 'Mith'],
        'Toroi':       ['Edreira', 'Kutd', 'Drago', 'Illyowi', 'Tamrisa'],
    ...
    'NBA Draft': {
        'Team Sons':   ['Nipa', 'Sune', 'Aimo', 'Mari', 'Patito'],
        'Team Jarra':  ['Jarra', 'Dakin', 'Aolob', 'Delta', 'Zas'],
        'Team Deivi':  ['Espectro', 'Tusky', 'Marakas', 'Liirex', 'Deivi'],
        'Team Dwailet':['Kingkai', 'Mitsu', 'Dwailet', 'Naroso', 'Asessino'],
        'Team Reiko':  ['Miki', 'Hohidna', 'Reiko', 'Lolex', 'Manue'],
        'Team Dato':   ['Kirby', 'Susty', 'Freddy', 'D4dtor', 'Sergi'],
    },
    'Open': {
        'Kaiju':     ['Myno', 'J Legend', 'Freddy', 'Davura', 'Sergi', 'Hyakko', 'Clavijos'],
        'Kb Amegos': ['Ragnarok', 'Lucas999', 'Marakas', 'LegendLegacy', 'Ironfranman', 'Sergi'],
        'Saru':      ['Styler', 'Susta', 'Alejandro', 'D4dtor', 'Rexito', 'Xenius'],
        'Arashi':    ['Artorias', 'BuZz', 'AnPuuR', 'Lolex', 'Torrente'],
        'Atsui':     ['Gatsu', 'Dakin', 'Sporfu', 'Dr Filtros', 'Coña mala', 'Lisbd'],
    ...
    'Sprint 4': {
        ...
        'Atsui':     ['Gatsu', 'Dakin', 'Sporfu', 'Dr Filtros', 'Coña mala', 'Komit', 'Dafenosa'],
        'Kamikaze':  ['Miki', 'Lolex', 'Ironfranman', 'Dafenosa'],
        'Kuru':      ['Comunisma', 'Hidon', 'Cariatis', 'LegendLegacy', 'Sons', 'KingKai', 'Zroly', 'Jfet'],
        'PSF':       ['Phantom', 'ILP', 'Lucyfer', 'NdeNero', 'Alatriste'],
        'Sorairo':   ['Farlopez', 'Polucion', 'Invictutus', 'Demon', 'Ranita', 'KingKai', 'Marakas', 'Wesele', 'MaikyG', 'Duncan'],
    ...
    'Split 3': {
        ...
        'Saru':       ['Juan Manuel', 'Susta', 'Alejandro', 'D4dtor', 'Rexito', 'Arxan', 'James', 'McJuanjoDLC'],
        ...
        'Amaterasu':  ['Tinky', 'ILP', 'SPJaina', 'Nihility', 'Coña mala'],
